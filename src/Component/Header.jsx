          ...
          <div className="flex items-center justify-between h-30">
            ...
            <div className="flex items-center space-x-8">
              ...
              {isLoggedIn ? (
                ...
                <Link to="/login" className="hidden md:inline-block bg-[#2C5AA0] hover:bg-[#1e3f73] text-white px-4 py-2 rounded-lg font-poppins font-semibold text-sm transition-colors duration-300 ml-8">
                  Login
                </Link>
              )}
            </div>
