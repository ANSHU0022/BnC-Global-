...
const StartChatting = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col overflow-x-hidden" style={{ fontFamily: 'Geist, Poppins, sans-serif' }}>
      ...
      <div className="flex-1 pt-2 flex flex-col lg:flex-row">
        <div
          ref={containerRef}
          className="flex flex-col lg:flex-row w-full h-[calc(100vh-6rem)]"
        ...
        >
          ...
          <div
            className="w-full h-full flex flex-col bg-white border-r border-gray-200 overflow-hidden"
